...
public class PublicacaoDTO {
    ...
    public PublicacaoDTO(Long id, String legenda, LocalDateTime dataHora, List<Interacao> interacoes) {
        this.id = id;
    ...
    public PublicacaoDTO(Long id, Long id1, LocalDateTime dataHora, String legenda, List<?> objects) {
    }
